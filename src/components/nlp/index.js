...
class Nlp extends Component {
  ...
  render(){
    return (
      <div>
        <svg width="300" height="300" style={{position: "absolute"}} viewBox="0 0 300 300">
